...
PNPThread::PNPThread(double fl, HoughThread* ht): m_web_string_stream(std::ios_base::in | std::ios_base::out | std::ios_base::ate)
{
	...
	m_object_matrix[1][0] = -2.0/3.0*10;
	m_object_matrix[2][0] = -1.0/3.0*10;
	m_object_matrix[3][0] = -1.0/3.0*10;
	m_object_matrix[0][1] =  0.0;
	m_object_matrix[1][1] =  1.0/3.0*10;
	m_object_matrix[2][1] = -1.0/3.0*10;
	m_object_matrix[3][1] =  2.0/3.0*10;
