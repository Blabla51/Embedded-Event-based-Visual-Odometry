...
public:
	HoughThread(int hough_map_x, int hough_map_y, double zone_x = 4, double zone_y = 4, double threshold = 30.0, int camera_x = 128, int camera_y = 128, int pc_exp_range = 1000000);
    ~HoughThread();
