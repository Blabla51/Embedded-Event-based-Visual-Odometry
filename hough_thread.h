...
public:
	HoughThread(int hough_map_x, int hough_map_y, double zone_x = 3, double zone_y = 3, double threshold = 19.0, int camera_x = 128, int camera_y = 128, int pc_exp_range = 1000000);
    ~HoughThread();
